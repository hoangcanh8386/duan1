    ...
    <div class="post">
        ...
        <div class="postall" style="display: flex;">
            <div class="baipost_1" style="margin-right: 200px; margin-left: 35px;">
                ...
                <p><a href="">Bùng nổ cảm xúc cùng sự kiện Festival <br> F-Shop ra mắt điện thoại mới diễn ra tại Hà Nội</a></p>

            </div>
            <div class="baipost_2">
                <img src="./image/hoithao1.png" alt="" width="500px" height="400px">
                <p>
                    <a href="">Tại hội thảo, các chuyên gia trong lĩnh vực điện thoại thông minh<br> đã tổ chức các buổi hội thảo</a>
                </p>
            </div>
        </div>
    </div>
